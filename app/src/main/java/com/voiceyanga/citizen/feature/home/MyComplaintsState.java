...
public class MyComplaintsState {
    ...
    public MyComplaintsState(List<Complaint> items, boolean isInitialLoading, boolean isRefreshing,
    ...
    public static MyComplaintsState createInitial() {
        return new MyComplaintsState(Collections.emptyList(), false, false, false, false, null, 0, 0, 0);
    }
